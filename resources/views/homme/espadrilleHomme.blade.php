...
@section('title')
Evatrine/espadrille_Homme
@endsection

@section('content')
<p style="font-size: 5vw;text-align:center;color:#12364E;font-weight:bold ">Espadrilles pour homme</p>
...
<div class="row" style="margin-top:50px;">
        ...
        <div style="display:inline-block;width:320px;margin:0 auto;" >
              ...
              <br>
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         ...
                         <span class="card__preci">{{$espadrille["prix"]}} DH</span>
                         <p class="card__description">{{$espadrille["description"]}}</p>
                         @if(!Auth::user())
            ...
            <div class="btn"><a href="{{route('espadrille.edit',$espadrille["id"])}}" class="btn btn-primary"> <img src="./uploads/modify.png" style="width:20px;margin-top:-5px"> Modifier</a></div>
            <form action="{{route('espadrille.delete',$espadrille->id)}}" method="POST">
              @csrf
              @method('DELETE')
              <div class="btn">
...
@section('style')
    <style>
        body{
            background-image:url("{{asset ('./uploads/homme_spadrine.png')}}");
